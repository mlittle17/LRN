...
const createEvent = async(req, res) => {
  try {
    const id = await db.query('INSERT INTO event (name, topic, description, duration, date, time, users_id, classLimit, uuid) VALUES ( ${name}, ${topic}, ${description}, ${duration}, ${date}, ${time}, ${user_id}, ${classLimit}, ${uuid}) RETURNING id', req.body);
    res.send(id);
  } catch (err) {
    console.log('nah bruh', err);
  }
